...
namespace ContosoSuitesWebAPI.Agents
{
    ...
    public class MaintenanceCopilot(Kernel kernel)
    {
        ...
        private ChatHistory _history = new ("""
            ...
            Only creating the maintenance request without saving it into the database is not a valid solution, you need to ask the use if it should be discarded if it should not be saved.
            """);
